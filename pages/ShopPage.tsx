  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="bg-base-200 p-8 rounded-2xl shadow-3d text-center mb-12">
        ...
        <p className="text-gray-300 mt-2">Find the perfect digital asset for your next project.</p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        {/* Filters */}
        <aside className="lg:col-span-1 bg-base-200 p-6 rounded-xl shadow-lg h-fit">
          ...
          <div className="mb-6">
            ...
            <input
              ...
              className="w-full bg-base-300 border border-base-100 rounded-md py-2 px-3 text-white focus:outline-none focus:ring-2 focus:ring-primary"
            />
          </div>
          <div className="mb-6">
          ...
          <div>
            <label htmlFor="sort" className="block text-white mb-2">Sort By</label>
            <select
              id="sort"
              value={sortBy}
