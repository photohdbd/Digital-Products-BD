...
const Footer: React.FC = () => {
    return (
        <footer className="bg-base-200 text-gray-400 mt-16">
            <div className="container mx-auto px-6 py-10">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <p className="text-gray-400 mt-2 text-sm">Join our list and be the first to receive exclusive offers, free gifts & resources.</p>
                        <form className="mt-4 flex">
                            <input type="email" placeholder="Enter your email" className="w-full bg-base-300 border border-gray-600 rounded-l-md py-2 px-3 text-white focus:outline-none focus:ring-2 focus:ring-primary" />
                ...
                <div className="mt-10 border-t border-gray-700 pt-6 text-center text-sm text-gray-500">
                    ...
                    <Link to="/admin" className="text-xs text-gray-600 hover:text-gray-400 mt-2 inline-block opacity-50 hover:opacity-100">Admin</Link>
                </div>
            </div>
        </footer>
    );
