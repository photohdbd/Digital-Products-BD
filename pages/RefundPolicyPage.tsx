  ...
  return (
    <div className="container mx-auto px-6 py-12 max-w-4xl">
      ...
      <div className="prose prose-lg text-gray-600 space-y-4">
        <p>Thank you for shopping at Digital Products BD.</p>
        ...
        <h2 className="text-2xl text-gray-800">General Policy</h2>
        <p>
        ...
        <h2 className="text-2xl text-gray-800">Conditions for Refunds</h2>
        <p>
