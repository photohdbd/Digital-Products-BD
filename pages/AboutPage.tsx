  ...
  return (
    <div className="container mx-auto px-6 py-12">
      <div className="text-center">
        <h1 className="text-4xl md:text-6xl font-bold text-white tracking-tight">About Olala<span className="text-primary">DOT</span></h1>
      ...
      <div className="mt-16 max-w-4xl mx-auto bg-base-200 p-8 md:p-12 rounded-2xl shadow-lifted border border-base-300">
        <div className="space-y-8 text-lg text-gray-300 leading-relaxed">
          ...
          <p>
            Thank you for choosing OlalaDOT. We look forward to serving you!
          </p>
        </div>
      </div>
    </div>
