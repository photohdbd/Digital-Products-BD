    ...
    <div className="space-y-8">
      ...
      <div className="space-y-6">
        {messages.map(message => (
          <div key={message.id} className="bg-base-200 p-6 rounded-xl shadow-lg">
        ...
        {messages.length === 0 && <p className="text-center p-8 text-gray-400 bg-base-200 rounded-xl">No messages received yet.</p>}
      </div>
    </div>
  );
};
